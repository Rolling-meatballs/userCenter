...
const api_registerPath = '/api/user/register';
const WHITE_LIST = [loginPath, registerPath, api_registerPath];
...
export async function getInitialState(): Promise<{
  ...
  const fetchUserInfo = async () => {
    try {
      ...
      console.log('app-fetchUser-msg 41', msg);
      return msg.data;
    } catch (error) {
...
export const layout: RunTimeLayoutConfig = ({ initialState, setInitialState }) => {
  return {
    ...
    onPageChange: () => {
      ...
      console.log('userAccount', initialState?.currentUser?.userAccount)
      const { location } = history;
